...
if(FALSE)
  set(beginner_tutorial_SOURCE_PREFIX /home/ping128/ros-ai/catkin_ws/src/beginner_tutorial)
...
if(NOT "/home/ping128/ros-ai/catkin_ws/install/include" STREQUAL "")
  set(beginner_tutorial_INCLUDE_DIRS "")
  set(absolute_include_dirs "/home/ping128/ros-ai/catkin_ws/install/include")
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /home/ping128/ros-ai/catkin_ws/install/${idir})
      set(include /home/ping128/ros-ai/catkin_ws/install/${idir})
    else()
      message(FATAL_ERROR "Project 'beginner_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ping128/ros-ai/catkin_ws/install/${idir}'.  Ask the maintainer 'ping128 <sping128@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ping128/ros-ai/catkin_ws/install/lib;/home/ping128/ros-ai/catkin_ws/devel/lib;/opt/ros/groovy/lib)
